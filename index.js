...
no.addEventListener("click", () => {
  if (count == 2) {
    ...
    text.innerHTML = "You want to press YES right?🥹";
    yes.style.height = "65%";
    yes.style.width = "60%";
    no.style.width = "30%";
    count++;
...
yes.addEventListener("click", () => {
  ...
  text.innerHTML = "Yeeee, I love you Sayangkuu😘";
  yes.innerHTML = '<a href="https://wa.wizard.id/6ef609">Message me</a>'; // inside the " " put your social media profile link
  yes.style.height = "90%";
  yes.style.width = "96%";
  no.style.display = "none";
  setTimeout(() => {
